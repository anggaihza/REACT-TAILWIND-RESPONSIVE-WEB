    ...
    <div className="max-w-[1248px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div>
        ...
        <p className="py-4">
          ...
          ut rem corporis beatae debitis praesentium, culpa repudiandae cum
          voluptatibus.
        </p>
      ...
      <dir className="lg:col-span-2 flex justify-between mt-6">
        <div>
        ...
        <div>
          <h1 className="font-medium text-gray-400">Careers</h1>
          <ul>
